...
const Footer = () => {
    return (
        <div className=" bg-[#26282B]">
            ...
            <div className="grid grid-cols-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 text-white pt-16 pb-12">
                ...
                <div className="text-left ml-16 sm:ml-0  mt-4 sm:mt-6 md:mt-0 sm:text-left md:text-right col-span-4 sm:col-span-1">
                    ...
                    <ul className="flex flex-row gap-4 text-lg mt-6 sm:mt-10 sm:ml-6 md: lg:ml-52">
